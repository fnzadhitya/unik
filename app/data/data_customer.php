              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="index.php?page=edit-data-customer&&id=<?php echo $pch['id_customer']; ?>" class="btn btn-sm btn-warning">Edit</a>
                      <a onclick="hapus_data(<?php echo $pch['id_customer']; ?>)" class="btn btn-sm btn-danger">Hapus</a>
                    </td>
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form method="get" action="add/tambah_data_customer.php">
